	...
	<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
						...
						<div class="row breadcrumbs-top d-inline-block">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active">แนะนำ Affiliate
									</li>
								</ol>
							</div>
						</div>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">ประวัติการแนะนำ Affiliate</h4>
									</div>
		...
		$(function(){
			...
			datatablePGGmage = $('.pg-data-table').DataTable( {
                "processing": true,
                "serverSide": true,
				"ajax": "<?php echo base_url('affiliate/list_log_aff_history_json')?>",
				"order": [[ 1, "desc" ]]
			} );
			$('.MenuAffiliatehistory').addClass('active');
			$('.daterange').daterangepicker({
				...
				datatablePGGmage.ajax.url("<?php echo base_url('affiliate/list_log_aff_history_json?date_begin=')?>"+start.format('YYYY-MM-DD')+"&date_end="+end.format('YYYY-MM-DD')).load();
			});
			$('.daterange').val("");
