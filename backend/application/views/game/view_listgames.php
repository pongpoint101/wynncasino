...
<html lang="th">
	...
	<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
									...
									<div class="card-content collpase show">
										...
										<div class="container-fluid">
													...
													<form class="form-inline" onsubmit="return false"> 
														<div class="form-group mx-sm-1">
															...
															<select class="form-control" id="provider_id"> 
																...
																<?php 
																foreach ($gamegroup['result_array'] as $k => $v) {
																	$cate_name='';
																	if($v['slug']!=''){
																		$cate_name=$v['slug'].' - ';
																	}
																	$cate_name=$cate_name.$v['name'];
																	?>
																	 <option value="<?=$v['platformId']?>"><?=$cate_name?></option> 
																	<?php
																}
																?> 
															</select>
											...
											<form onsubmit="return false;" class="myway-form-providers" method="post" action>
											   <input type="hidden" name="game_type" value="gamelist" >
												<table class="table table-striped table-bordered ajax-sourced pg-data-table table-middle p-0">
													<thead>													
														<tr>
															...
															STATUS <input type="checkbox" id="chk_all" value="0">
															</th> 
		...
		$(function(){
			$('.MenuEnablelobbygames').addClass('active');
			datatablePGGmage = $('.pg-data-table').DataTable( { 
				"ajax": {
				"url": "<?php echo base_url('games/ListDatagames')?>",
				"data": function ( d ) {
				   return $.extend( {}, d, {
