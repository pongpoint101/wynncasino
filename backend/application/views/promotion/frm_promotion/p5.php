...
<form class="form" onSubmit="return false" method="post" enctype="multipart/form-data" id="form_promotion">
    ...
    <div class="form-body">    
        ...
        <div class="row pro_deposit_type_fix" > 
                  <div class="col-md-10">
                    <div class="form-group">
        ...
        <div class="row"> 
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="pro_deposit_amount">ยอดสะสมเริ่มต้น</label>
                        <input type="number"   class="form-control" placeholder="ยอดสะสมเริ่มต้น" value="<?=$pro_data['row']->pro_deposit_start_amount?>" name="pro_deposit_start_amount" />
                    </div>
                  </div>  
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="pro_deposit_amount">ยอดสะสมสิ้นสุด</label>
                        <input type="number"   class="form-control" placeholder="ยอดสะสมสิ้นสุด" value="<?=$pro_data['row']->pro_deposit_end_amount?>" name="pro_deposit_end_amount" />
                    </div>
                  </div>

                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="pro_deposit_amount">ยอดฝากของเดือนถัดไป</label>
                        <input type="number"   class="form-control" placeholder="ยอดฝากของเดือนถัดไป" value="<?=$pro_data['row']->pro_last_deposit_amount?>" name="pro_last_deposit_amount" />
                    </div>
                  </div>
        ...
        <div class="form-group">
            <label>เทิร์นโอเวอร์</label>
            <div class="input-group">
                <div class="d-inline-block custom-control custom-radio mr-1">
                    <input type="radio" name="pro_turnover_type" class="custom-control-input" value="1" <?=(@$pro_data['row']->pro_turnover_type==1) ? 'checked' : '';?> id="pro_turnover_type_open" />
                    <label class="custom-control-label" for="pro_turnover_type_open">คำนวณจากยอดเล่น</label>
                </div>
                <div class="d-inline-block custom-control custom-radio">
                    <input type="radio" name="pro_turnover_type" class="custom-control-input" value="2" <?=(@$pro_data['row']->pro_turnover_type==2) ? 'checked' : '';?>  id="pro_turnover_type_close" />
                    <label class="custom-control-label" for="pro_turnover_type_close">คำนวนจากยอดเครดิต</label>
                </div>
            </div>
        </div> 
        <div class="form-group">
