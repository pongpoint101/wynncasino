		...
		<div class="content-wrapper">
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
					<h3 class="content-header-title mb-0 d-inline-block">ประวัติการแก้ไข Aff</h3>
					<div class="row breadcrumbs-top d-inline-block">
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo base_url() ?>">Home</a>
								</li>
								<li class="breadcrumb-item active">ประวัติการแก้ไข Aff
								</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">ประวัติการแก้ไข Aff</h4>
								</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			datatablePGGmage = $('.pg-data-table').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "<?php echo base_url('reports/admin_update_aff_json') ?>",
				"order": [
					[3, "desc"]
				]
			});
			$('.MenuTotalAdminUpAff').addClass('active');
