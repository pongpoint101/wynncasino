...
<head>
    ...
    <link rel="stylesheet" href="<?=GetFullDomain()?>/assets/css/style.css?v=98" />
    ...
    <!-- Local CSS -->
    <link rel="stylesheet" href="<?=GetFullDomain()?>/assets/css/common_style.css?v=41">
    ...
    <link rel="stylesheet" href="<?=GetFullDomain()?>/assets/css/siteground-optimizer.css?v=4" />
    <?php 
...
<?php
  if(isset($_SESSION['member_no'])){
    ...
    include_once ROOT_APP.'/componentx/tpl_homepage.php';  
  }
?>