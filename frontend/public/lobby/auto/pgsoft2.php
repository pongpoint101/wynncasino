...
<body style="margin:0;">
                    ...
                    <div class="row">
                        ...
                        if (@sizeof($PGGameList) > 0) {
                            foreach ($PGGameList as $key => $value) {
                                ...
                                echo '<a onclick="SelectGame(' . $sParam . ')" style="cursor: pointer;color: #ffc107;" class="game-title">' . $value['game_name_tha'] .  '</a>';
                                echo '</div>';
                                echo '</div>';
                            }
    ...
    <script type="text/javascript">
        ...
        function SelectGame(v_username, v_game_code, v_product) {
            let winOpen = window;
            var gamename=basegameshowlist['pgsindex'+v_game_code];
            var lastkey1="1gameselect"+v_product; var lastkey2="2gameselect"+v_product;
