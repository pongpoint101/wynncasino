...
switch ($res['member_promo']) {
  ...
  case 33: // โปรฝาก 100 ให้ 100% - เฉพาะ Casino
...
$listGames = $db->query("SELECT * FROM ka_list_games WHERE game_type='fish' AND status=1")->fetchAll();
...
<head>
  ...
  <title><?=$site['brand_name']?> - kagaming</title>
...
<body style="margin:0;">
  ...
  <div class="container">
    ...
    <a href="<?php echo $site['host'] ?>/lobby"><i class="las la-home la-3x"></i>
