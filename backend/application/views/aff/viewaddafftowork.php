...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
														...
														<div class="col-sm-12 pb-2">
														   <form class="form-inline" method="GET">
															...
															<div class="form-group">
																<label class="sr-only">รหัส สมาชิก:</label>
																<input type="text" value="<?=$memberoriginno?>" id="memberoriginno" required name="memberoriginno" class="form-control" placeholder="รหัส สมาชิก">
															</div>   
														...
														<div class="col-sm-12 pb-2">
														   <form class="form-inline pull-right" method="GET" id="frm_fransfer">
															...
															<div class="form-group boxmoveaff">
																<label class="sr-only">รหัสผู้แนำนำชั้นที่ 1:</label>
																<input type="text" value="<?=$memberoriginno?>" id="member_origin_no" required name="member_origin_no" class="form-control" placeholder="รหัสผู้แนำนำชั้นที่ 1" >
															</div>  
                                                            <div class="form-group boxmoveaff">
                                                              &nbsp;&nbsp;<i class="icon-arrow-right font-large-2 float-left"></i>
															</div>  
                                                            <div class="form-group mx-sm-1 boxmoveaff">
																<label class="sr-only">รหัสผู้แนำนำชั้นที่ 2 :</label>
																<input type="text" value="<?=$member_destinationno?>" id="member_destination_no" name="member_destination_no" class="form-control" placeholder="รหัสผู้แนำนำชั้นที่ 2">
															</div>  
		...
		$(function(){
			$('.MenuAffiliateref_addaffwork').addClass('active'); 
			$("#check_affgroupall").click(function() {
			  ...
			  $("#frm_fransfer").submit(function(e) {  
				...
				if(Object.keys(frm_l1_affwork).length<=0&&Object.keys(frm_l2_affwork).length<=0){alert('ไม่พบข้อมูลกรุณาเลือกข้อมูล ผู้แนะนำ สมาชิกชั้น 1 หรือ ผู้แนะนำ สมาชิกชั้น 2 ก่อนคะ'); return} 
				 ...
				 if(action=='transfer'){
					if(member_originno.length<5){alert('กรุณาระบุ รหัส สมาชิก'); $('#member_origin_no').focus(); return} 
